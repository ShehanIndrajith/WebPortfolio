...
gradient.addColorStop(0, "#4338ca"); // Start red
gradient.addColorStop(1, "#7877c663");
 // End blue
ctx.strokeStyle = gradient;
      ...
      return {
        ...
        tick(t) {
          ...
          pts.forEach((pt) => {
            ...
            let dir = len < innerWidth / 10 ? 0.1 : -0.1;
            pt.r = r;
    ...
    // Throttle pointermove events
    const throttledPointerMove = _.throttle((e) => {
    ...
    const animate = (t) => {
      ...
      ctx.fillStyle = "#000109";
      drawCircle(0, 0, w * 10);
      ctx.fillStyle = ctx.strokeStyle = "#e1e3f5";
      t /= 1000;
      spiders.forEach((spider) => spider.tick(t));
      requestAnimationFrame(animate);
    };

    addEventListener("pointermove", throttledPointerMove);
    requestAnimationFrame(animate);

    return () => {
      removeEventListener("pointermove", throttledPointerMove);
    };
  }, []);
